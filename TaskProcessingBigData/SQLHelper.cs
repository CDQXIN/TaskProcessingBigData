...
{
    /// <summary>
    /// The PSqlHelper class is intended to encapsulate high performance, scalable best practices for 
    ...
    public sealed class SQLHelper
    {
        ...
        // instances from being created with "new PSqlHelper()"
        private SQLHelper()
        {
        }
        ...
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">An array of SqlParameters to be associated with the command or 'null' if no parameters are required</param>
        /// <param name="connectionOwnership">Indicates whether the connection parameter was provided by the caller, or created by PSqlHelper</param>
        ...
        /// <summary>
        /// This enum is used to indicate whether the connection was provided by the caller, or created by PSqlHelper, so that
        /// we can set the appropriate CommandBehavior when calling ExecuteReader()
        /// </summary>
        private enum SqlConnectionOwnership
        {
            /// <summary>Connection is owned and managed by PSqlHelper</summary>
            Internal,
                    ...
                    for (int index = 0; index < tableNames.Length; index++)
                    {
                        if (tableNames[index] == null || tableNames[index].Length == 0)
                            throw new ArgumentException(
                                ...
                                "tableNames");
                        //这是原方法里的,网上说如果表大于三个,会返回成第二个表的内容
                        /******/
        ...
        //public static readonly string CONN_STRING = System.Configuration.ConfigurationManager.AppSettings["strConn_SqlCon"];
        //public static readonly string CONN_STRING = DBConnection.retrnCon();

        #region SqlBulkCopy
        public static void SqlBulkCopy(string connectionString, string TableName, DataTable dt)
        {
    ...
    public sealed class SQLHelperGetField
    {
        // Disallow Construction 
        private SQLHelperGetField()
        {
        }
